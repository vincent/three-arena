define('threearena/shaders/lifebar',
    ['lodash', 'threejs'],
     ...
     */
    var LifebarShaderMaterial = function(strands) {
    ...
    LifebarShaderMaterial.prototype = Object.create(THREE.ShaderMaterial.prototype);
    ...
    LifebarShaderMaterial.prototype.constructor = LifebarShaderMaterial;

    return LifebarShaderMaterial;
});