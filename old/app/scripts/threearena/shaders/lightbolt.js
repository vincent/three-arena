define('threearena/shaders/lightbolt',
    ['lodash', 'threejs'],
     ...
     */
    var LightboltShaderMaterial = function(strands) {
    ...
    LightboltShaderMaterial.prototype = Object.create(THREE.ShaderMaterial.prototype);
    ...
    LightboltShaderMaterial.prototype.constructor = LightboltShaderMaterial;

    return LightboltShaderMaterial;
});
