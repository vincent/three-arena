define('threearena/shaders/circles',
    ['lodash', 'threejs'],
     ...
     */
    var CirclesShaderMaterial = function(strands) {
    ...
    CirclesShaderMaterial.prototype = Object.create(THREE.ShaderMaterial.prototype);
    ...
    CirclesShaderMaterial.prototype.constructor = CirclesShaderMaterial;

    return CirclesShaderMaterial;
});