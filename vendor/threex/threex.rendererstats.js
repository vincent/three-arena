...
THREEx.RendererStats	= function (){
	...
	msText.style.cssText = 'color:#f00;font-family:consolas,monospace,sans-serif;font-size:9px;font-weight:bold;line-height:15px';
	...
	for(var i = 0; i < nLines; i++){
		...
		msTexts[i].style.cssText = 'color:#f00;background-color:#311;font-family:consolas,monospace,sans-serif;font-size:9px;font-weight:bold;line-height:15px';
