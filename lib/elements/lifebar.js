...
function LifeBar (options) {
  ...
  this.lifebar = new THREE.Mesh(new THREE.PlaneBufferGeometry(10, 1, 50, 1), this.lifebarMaterial);
  ...
  this.manabar = new THREE.Mesh(new THREE.PlaneBufferGeometry(10, 1, 50, 1), this.manabarMaterial);
