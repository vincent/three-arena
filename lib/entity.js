...
var LearnEffect    = require('./spell/flatlearn');
...
inherits(Entity, GameObject);

//////////////////
// Mock EventEmitter using ThreeJS builtin methods

Entity.prototype.on   = Entity.prototype.addEventListener;
Entity.prototype.off  = Entity.prototype.removeListener = Entity.prototype.removeEventListener;
...
Entity.prototype.cast = function(spell, target) {
  ...
  if (spell.start(this, target)) {
    this.emit('cast', { spell: spell, target: target });
  }
