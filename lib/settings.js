...
settings.exportConfig = function () {
  var settingsData = {};
  for (var key in settings.data) {
    if (['container', 'preload', 'stats'].indexOf(key) === -1) {
...
settings.importConfig = function (settingsData) {
...
settings.showConfig = function () {
  console.log(JSON.stringify(settings.exportConfig(), null, 4));
}
...
settings.data = {
    ...
    /**
     * NavigationMesh type (solo|tiled)
     * @type {String}
     */
    navmeshType: 'tiled',

    /**
     * Navigation layer type (auto|raw|navmesh|bottom|average)
     * @type {String}
     */
    navigationLayer: 'auto',
     ...
     */
    entityNamesSize: 1,
    entityNamesFont: 'helvetiker',
    entityNamesColor: '#00ff00',
    ...
    questSpriteStart: '/gamedata/textures/exclamation.png',
    questSpriteEnd: '/gamedata/textures/interrogation.png',
