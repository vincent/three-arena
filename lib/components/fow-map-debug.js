...
module.exports = function (arena) {
  ...
  arena.on('set:terrain', function () {
    ...
    // texture
    var fowtexture = new THREE.Texture(null);
    ...
    var material = new THREE.ShaderMaterial({
      ...
      uniforms: THREE.UniformsUtils.merge( [
        ...
        'tDiffuse1'         : { type: 't', value: fowtexture },
        'tDiffuse2'         : { type: 't', value: fowtexture },
    ...
    var uniforms = {
      ...
      'fowtexture'    : { type: 't',  value: fowtexture },
    ...
    arena.on('update', function () {
      ...
      _.each(arena.entities, function (e, i) {
        // set entity location
        entities[i  ] = e.position.x;
        entities[i+1] = e.position.y;
        entities[i+2] = e.position.z;
