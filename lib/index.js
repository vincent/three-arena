...
var Arena = function (overrideSettings) {
  ...
  this.commonMaterials = {
    ...
    'entityHelpers': new THREE.MeshBasicMaterial({
      ...
      color: 0xff0000,
      transparent: true,
      opacity: self.settings.visibleCharactersHelpers ? 0.8 : 0
    })
...
Arena.prototype._initLights = function(done) {
  ...
  this.ambientLight = new THREE.AmbientLight( self.settings.lightAmbientColor );
  ...
  */
  ...
  this.pointLight = new THREE.SpotLight( self.settings.lightPointColor, 1, 100, Math.PI );
  this.pointLight.shadowCameraVisible = true;
  ...
  this.directionalLight = new THREE.SpotLight( self.settings.lightDirectionalColor, 1, 800 );
